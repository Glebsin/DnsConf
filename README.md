...
3) Create new environment called `DNS`
...
+ You can run the action manually via `Run workflow` button: switch to Actions tab and choose workflow named **DNS Block&Redirect Configurer cron task**